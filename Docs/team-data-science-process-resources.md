...
|**Supported Data Science Languages**|**Python, R, Julia, SQL, Hive**|**Python, Microsoft R Services, Scala**|**SQL**|**U-SQL Queries**|**Hive Queries, UDF in Python**|**SQL, R**|
